...
@section('title', 'Edit Service - BengkelPro')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">Edit Service</h1>
        <p class="text-gray-500 dark:text-slate-400 mt-1 text-sm">Perbarui informasi layanan bengkel.</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="specialization" required
                        value="{{ old('specialization', $service->specialization) }}"
                ...
                <button type="submit"
                    ...
                    <i class="fa-solid fa-save"></i> Update Data Service
                </button>
            </div>
        </form>
    </div>
